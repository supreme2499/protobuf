...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // адрес электронной почты для регистрации пользователя
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // пароль пользователя для регестрации
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // почта пользователя для входа в систему
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // пароль пользователя для входа в систему
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // индефикатор приложения для входа в систему
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // токен аунтификации вошедшего в систему пользователя
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // id пользователя для индефикации
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x17, 0x73, 0x70, 0x72, 0x65, 0x6d, 0x65, 0x32, 0x34, 0x39, 0x39, 0x2e, 0x73, 0x73, 0x6f,
